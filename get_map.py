...
if __name__ == "__main__":
    ...
    map_vis = False
    dataset_path = 'DOTA/Multi'

    map_out_path = 'map_out'

    image_ids = open(os.path.join(dataset_path, "ImageSets/Main/.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        for image_id in tqdm(image_ids):
            with open(os.path.join(map_out_path, "ground-truth/" + image_id + ".txt"), "w") as new_f:
                ...
                root = ET.parse(os.path.join(r'C:\Users\Kazusa\Desktop\DOTA_VAL_BASE\XML', image_id + ".xml")).getroot()
